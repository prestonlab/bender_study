#!/usr/bin/env python
#
# Estimate a betaseries model for one participant.
...
pattern = os.path.join(fsf_dir, "fsf", "{}_{}*.fsf".format(args.model, args.subject))
...
if args.out_dir is None:
    out_dir = os.path.join(data_dir, "batch", "glm", args.model, "beta", args.subject)
else:
...
for f in fsf_files:
    ...
    log.run("bender_betaseries.py {} {} {:d}{}".format(base, out_dir, args.n, opt))
