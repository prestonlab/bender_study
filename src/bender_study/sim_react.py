...
class SimCatReact(Measure):
    ...
    def __call__(self, dataset):
        rho = 1 - cdist(
            dataset[self.split_ind[0]], dataset[self.split_ind[1]], "correlation"
        )
...
class SimCatReactSME(Measure):
    ...
    def __call__(self, dataset):
        ...
        for i in range(self.n_perm + 1):
            if (
                self.wr_ind[i][0].size == 0
                or self.br_ind[i][0].size == 0
                or self.wf_ind[i][0].size == 0
                or self.bf_ind[i][0].size == 0
            ):
                continue
...
class SimSubcatReactSME(Measure):
    ...
    def __call__(self, dataset):
        ...
        for i, cat_ind in enumerate(self.cat_ind):
            if (
                self.wr_ind[i][0][0].size == 0
                or self.br_ind[i][0][0].size == 0
                or self.wf_ind[i][0][0].size == 0
                or self.bf_ind[i][0][0].size == 0
            ):
                continue
